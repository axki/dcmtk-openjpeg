...
MACRO(DCMTK_ADD_LIBRARY LIBRARY)
    ...
    IF(NOT BUILD_SINGLE_SHARED_LIBRARY)
        ...
        INSTALL(TARGETS ${LIBRARY}${DCMTK_LIBRARY_SUFFIX}
          ...
          RUNTIME DESTINATION ${DCMTK_INSTALL_BINDIR}/Debug COMPONENT bin
          LIBRARY DESTINATION ${DCMTK_INSTALL_LIBDIR}/Debug COMPONENT shlib
          ARCHIVE DESTINATION ${DCMTK_INSTALL_LIBDIR}/Debug COMPONENT lib)

        INSTALL(TARGETS ${LIBRARY}${DCMTK_LIBRARY_SUFFIX}
          EXPORT DCMTKTargets
          CONFIGURATIONS RelWithDebInfo
          RUNTIME DESTINATION ${DCMTK_INSTALL_BINDIR}/Release COMPONENT bin
          LIBRARY DESTINATION ${DCMTK_INSTALL_LIBDIR}/Release COMPONENT shlib
          ARCHIVE DESTINATION ${DCMTK_INSTALL_LIBDIR}/Release COMPONENT lib)
